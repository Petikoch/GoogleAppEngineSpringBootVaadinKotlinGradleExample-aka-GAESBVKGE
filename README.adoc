...
The implementation of the "half objects pattern" syncs e.g. the value of a textfield  in client-side browser with the corresponding half object on the server-side.
