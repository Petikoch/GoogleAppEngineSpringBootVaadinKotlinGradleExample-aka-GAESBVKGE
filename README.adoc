...
This has a potential huge impact on the way you write your application.
...
This gives you many more other benefits beside of beeing able to run in a **highly dynamic environment**
