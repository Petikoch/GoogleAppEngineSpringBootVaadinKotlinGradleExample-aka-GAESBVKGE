...
and only keep the "essential" (UI-Toolkit agnostic) UI-State "somewhere" in a "high-available" fashion and use a technology like Vaadin just as replaceable UI-State "renderer".
